...
<section id="comp-product">
	<div class="container">
		...
		<div class="row" id="border-row">
			<div class="versus">
				<img src="<?php bloginfo('template_directory');?>/images/compare-arrow.png"  width="33" height="45"/>
			</div>
				<div class="col-md-6 column-setting" id="myCol2">
					<div class="left-image-main-div">
						<?php 
						...
						<?php 
							echo  '<img src="'.$image_attributes[0].'"  width="120"height="120"/>'; 
							endif; 
...
<!-- 							<div class="product-description">
 ...
 -->
							<?php 
								if (!empty($video_url)) {
									echo '<span id="video-demo">
											<a class="fancybox-media" rel="media-gallery" href='.$video_url.'>
												<i class="fa fa-youtube-play"></i> VIDEO DEMO
											</a>
										  </span>'	;
								} 
					 		?>
							<?php
							echo '</div>'; // End of product-info div
							$hp[]          = $all_feature['hp'];
			...
			<div class="col-md-6 column-setting" id="myCol4">
				<div class="right-image-main-div">
				<?php 
					unset($loop);
					$loop = '';
				...
				?>
					<div class="right-image-div">
						<?php echo  '<img src="'.$image_attributes[0].'"  width="120"height="120"/>'; ?>
				<?php
					endif;
				echo '<div class="product-info">';
					echo '<h5 class="pro-title">';
...
<section>
	<div class="container">
		<table class="table table-hover table-striped table-bordered table-responsive">
			...
			<!-- <tr>
				<th></th>
				<td class="table-data"><a href="#" class="btn btn-primary">View Product Deatils</a></td>
				<td class="table-data"><a href="#" class="btn btn-primary">View Product Deatils</a></td>
			</tr>
 -->
		</table>
