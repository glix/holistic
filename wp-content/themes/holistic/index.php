...
<section id="mainSlider">
	<div class="container">
		...
		<div class="col2">
					...
					<div id="productCarousel" class="everslider">  
						<ul class="es-slides" id="product_list_wrapper">  
							...
							<?php
								...
								?>
								<a href="<?php the_permalink(); ?>"><?php echo $class; ?>
									<?php 
			...
			<div class="view-all-products"><a href="<?php echo get_permalink(get_page_by_path('products')); ?>">view all reviews</a></div>
		</div> 
	</div>
</section>
<section id="comparisons">
						...
						<div class="col-md-4 comparing-cols">
							<div class="compare-img">
								<?php
									...
									$the_query = new WP_Query($arg_tex);
									
									if ( $the_query->have_posts() ) :
										 while ( $the_query->have_posts() ) : $the_query->the_post();
											$custom_fields = get_post_custom($the_query->post->ID); 
											$product_ids = unserialize($custom_fields['compare']['0']);
											echo "<div class='row'><a href='compare-product/?product1=".$product_ids['compare_product1_id']."&product2=".$product_ids['compare_product2_id']."'>";
											echo "<p>";
											$compare_tex_values = get_the_terms( $the_query->post->ID, 'comparison' );
											foreach ($compare_tex_values as  $values) {
												echo 'Most compared '.$values->name;
											}
											echo "</p>";
									 	...
									 	foreach ($product_ids as $id) :
											...
											if ($one) {
												 echo '<div class="vs col-md-2" style="padding:0;">
												 ...
												 echo '<div class="first-vs col-md-5">';
												 if ($image_attributes) :
	...
	<div class="text-right"><a class="btn-grey" href="<?php echo get_permalink(get_page_by_path('most-compared')); ?>">view all popular comparisons</a></div>
</div>
</section>
<section id="guide">
	<div class="container">
		...
		<div class="guide-tabs">
			<ul class="nav nav-tabs" role="tablist">
				...
				<li><a href="#scamWatchAndUpdates" role="tab" data-toggle="tab"><img src="<?php echo IMAGES ?>/scam.png" />SCAM WATCH AND UPDATES</a></li>
			</ul> 
			<div class="tab-content">
				<!-- start things to consider before u buy section -->
				...
				<!-- end things to consider before u buy section -->
				<!-- start claims to avoid section -->
				...
				<!-- end claims to avoid section -->
				<!-- start scam watch section -->
				...
				<!-- end scam watch section -->
			</div>
		</div>
		<div class="text-right"><a href="<?php echo get_permalink(get_page_by_path('buyers-guide')); ?>">view all buyer info</a></div>
	</div>
</section>
<!-- Main Container End -->
<?php get_footer(); ?>
